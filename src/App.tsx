  ...
  return (
    <div className="h-dvh flex flex-col bg-gray-950 text-white overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className={['flex-1 flex flex-col overflow-hidden', mobileTab !== 'streamers' ? 'hidden lg:flex' : 'flex'].join(' ')}>
          <StreamerGrid
            streamers={streamers}
        ...
        <div className={[mobileTab !== 'leaderboard' ? 'hidden lg:flex' : 'flex flex-1 flex-col lg:flex-none'].join(' ')}>
